...
public class OverloadEffect extends StatusEffect {
    private static final double BASE_SPEED_DECREASE = 0.3; // Base decrease in speed (30%)
    private static final double BASE_ATTACK_SPEED_DECREASE = 0.3; // Base decrease in attack speed (30%)
    private static final double BASE_DAMAGE_REDUCTION = 0.3; // Base reduction in damage (30%)
